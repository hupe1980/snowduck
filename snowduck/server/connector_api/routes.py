...
def get_connector_api_routes() -> list[Route]:
    ...
    return [
        ...
        Route("/session/heartbeat-request", handlers.heartbeat_request, methods=["POST"]),
        Route("/session/authenticator-request", handlers.authenticator_request, methods=["POST"]),
        ...
        Route("/queries/v1/query-request/{queryId}", handlers.get_query_result, methods=["GET"]),
